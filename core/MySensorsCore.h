...
*/
bool send(MyMessage *msg, bool ack); //**********!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! &msg !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// Inline function and macros
 MyMessage build(MyMessage *msg, uint8_t sender, uint8_t destination, uint8_t sensor, uint8_t command, uint8_t type, bool enableAck) {
	msg.sender = sender;
...
MyMessage buildGw(MyMessage *msg, uint8_t type) {
